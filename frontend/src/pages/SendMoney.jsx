          ...
          <div className="p-6">
            ...
            <div className="space-y-4 pt-4">
              ...
              <button
                ...
                className="flex justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white cursor-pointer"
              >
                Cancel & Go Back
              </button>
            </div>
